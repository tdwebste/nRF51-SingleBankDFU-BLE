...
#else
    #define PSTORAGE_RAW_START_ADDR   0x00016000                                                /**< Start address for Raw access mode, configurable based on use case. */
#endif

#define PSTORAGE_RAW_END_ADDR       0x0003C000                                                  /**< End address for Raw access mode, configurable based on use case. */
